...
//    // IN generic delegate we do not use to invoke and write delegate methord.
//    // DO we really need to create custom Delegates to invoke the methods in C#?        --  NO with the use of generic delelgate.
